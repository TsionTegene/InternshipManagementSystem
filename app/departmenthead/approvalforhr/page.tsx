        ...
        <div>
            <div className="bg-white shadow-md rounded-md p-9 mb-4 relative flex items-center">
                ...
                <div className="absolute bottom-4 right-4 flex space-x-2">
                    <button className="bg-green-500 text-white px-9 py-2 rounded-full">Approve</button>
                    <button className="bg-red-500 text-white px-9 py-2 rounded-full">Reject</button>
                </div>
            </div>
