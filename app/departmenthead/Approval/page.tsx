...
import { useApproveStudents, useStudentsFetchByDep } from '@/hooks/useStudentsActions';
      ...
      <Table>
        ...
        <TableBody>
          ...
          <div className='flex gap-4'>
                          <Button onClick={() => approve(student.id)} className='bg-emerald-500'>Approve</Button>
                          <Button onClick={() => reject(student.id)} className='bg-red-600'>Reject</Button>
