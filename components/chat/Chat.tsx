...
//     isUser: false,
//     content: "Hello there!",
//     timestamp: "10:00 AM", // Optional timestamp
//   },
//   {
//     isUser: true,
...
// const Chat = () => {
//   return (
//     <div className="conversation overflow-hidden bg-gray-200">
//       <div className="chatInfo flex bg-slate-600 gap-2 items-center p-3 rounded-t-xl">
//         <Avatar>
...
//               <li key={message.content} className={message.isUser ? "items-end" : "items-start"}>
...
//               <li key={message.content} className={message.isUser ? "message right" : "message left"}>
//                 <Message isUser={message.isUser} content={message.content} timestamp={message.timestamp} />
//               </li>
